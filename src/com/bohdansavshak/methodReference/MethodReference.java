...
public class MethodReference {
  ...
  public static void main(String[] args) {
    ...
    Stream.of("e1", "e2")
        .forEach(MethodReference::staticMethod); // e -> MethodReference.staticMethod(e)
    ...
    Stream.of("e1", "e2")
        .forEach(methodReferenceObj::instanceMethod); // e -> methodReferenceObj.instanceMethod(e)

    // 4. Reference to constructor
    Function<String, MethodReference> function =
        MethodReference::new; // e -> new MethodReference(e);
  }
