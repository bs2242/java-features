...
public class Introduction {
    ...
    If one of the bounds a class it must be specified as first. In this case B1 must be a class of T extends from a class.
    ...
    public static class Util {
        ...
        public static void main(String[] args) {
            ...
            boolean isSame = Util.<Integer, String>compare(p1, p2); // Explicit was of telling java which type arguments
    ...
    public static class BoxAsGenericType<T> { // <T> in this case is called type parameter or type variable.
    ...
    public static void main(String[] args) {
        ...
        // Let's say you have Collections class which exists already in java 4 but since 5 there are generics added.
        ...
        // List but since java 5 you would get parameterized type List<Something> which will break you code
...
//            boundedTypeOfInteger.inspect("Str"); // this throws compile time error because inspect can only
...
//        }
    ...
    public static class GenericHierarchy {
        public static void main(String[] args) {
            ...
            // also because List<E> extends from Collection<E> it means when Collection<E> is expected you can pass in List<E>

        }

        // example of my own generic type that extends from another generic type.
        // so technically by doing generic type invocation like ListWithPayLoad<String, Integer> it extends from List<String>.
        ...
        public static interface ListWithPayload<E, P> extends List<E> {
