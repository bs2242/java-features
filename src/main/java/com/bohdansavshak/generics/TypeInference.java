...
public class TypeInference {
  ...
  /*
  Type Inference - is a thing in java which make conclusion which type argument to be used based on arguments that
  you pass to your methods.
  if you have generic method that accepts U and List<U> then just by adding Integer.valueOf(10) as first argument java
  already knows that type in this case would be Integer and you don't need to specify type explicitly when calling a
  method.
