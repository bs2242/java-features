...
public class Ex2 {
    ...
    record A(int i) {} // hashCode, equals, toString  and canonical constructor plus i() method
    ...
    /*
    everything is static when you declare it in another class.
    except class it's implicitly non-static
     */
}
