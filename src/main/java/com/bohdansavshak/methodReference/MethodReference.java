...
public class MethodReference {
	...
	public static void main(String[] args) {
		/*
		 * 1. Static method reference 2. Instance method reference of an arbitrary object
		 * of a particular type (Unbound method reference) 3. Instance method reference of
		 * a particular object (Bound method reference) 4. Constructor method reference
		 */

		// 1. Static method reference example
		Stream.of("e1", "e2").forEach(MethodReference::staticMethod); // e ->
																		// MethodReference.staticMethod(e)
		...
		Stream.of("e1", "e2").forEach(methodReferenceObj::instanceMethod); // e ->
																			// methodReferenceObj.instanceMethod(e)

		// 4. Reference to constructor
		Function<String, MethodReference> function = MethodReference::new; // e -> new
																			// MethodReference(e);
	}
